...
class HeaderContentView: UIView , UIScrollViewDelegate {
    ...
    func addHeaderPages() {
      _ = HeaderPage(page: pages[0] as! UIView,
                           imageView: imageView,
                           label: label,
                           labelDesc: labelDesc,
                           cyanBox: cyanBox,
                           imageName: "chair.png",
                           description: "Green \ncomfort chair")
      _ = HeaderPage(page: pages[1] as! UIView,
      ...
      _ = HeaderPage(page: pages[2] as! UIView,
